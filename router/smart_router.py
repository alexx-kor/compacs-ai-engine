"""Smart prompt router with few-shot example injection."""
        ...
        for file_path in folder_path.rglob("*"):
            if file_path.suffix == '.csv':
                try:
                    ...
                    log.exception("failed loading csv examples path=%s: %s", file_path, exc)
                    raise
                ...
                try:
                    ...
                    log.exception("failed loading txt examples path=%s: %s", file_path, exc)
                    raise
...
try:
    ...
    log.warning("few-shot examples unavailable, continuing without them: %s", exc)
    FEW_SHOT_EXAMPLES = []
